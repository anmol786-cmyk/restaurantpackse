...
// Legacy anmol functions - redirect to Anmol Wholesale (kept for backward compatibility)
export function anmolOrganizationSchema(baseUrl: string = 'https://restaurantpack.se'): Organization {
  return anmolWholesaleOrganizationSchema(baseUrl);
}

export function anmolOrganizationSchemaFull(baseUrl: string = 'https://restaurantpack.se'): Organization {
  return anmolWholesaleOrganizationSchemaFull(baseUrl);
}
