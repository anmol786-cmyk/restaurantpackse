            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex-1 flex justify-center items-center relative h-48 md:h-64 w-full">
                        ...
                        <div className="relative z-10 p-8 bg-card rounded-2xl shadow-xl transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                    ...
                    <div className="hidden lg:flex items-center gap-4 bg-card p-4 rounded-xl shadow-sm border border-border/50">
