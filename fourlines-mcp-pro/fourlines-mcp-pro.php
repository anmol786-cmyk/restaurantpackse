 ...
 * Plugin URI: https://restaurantpack.se
 * Description: Model Context Protocol integration for WooCommerce - exposes shipping, products, and orders via REST API for Anmol Wholesale
 * Version: 1.0.0
 * Author: Anmol Wholesale
 * Author URI: https://restaurantpack.se
 ...
 */
define('FOURLINES_FRONTEND_URL', 'https://restaurantpack.se');
