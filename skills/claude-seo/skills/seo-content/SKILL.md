...
**Wholesale B2B overrides (restaurantpack.se):**
| Page Type | Minimum | Why |
|-----------|---------|-----|
| Product page (bulk ingredient) | 400+ | Need: product specs, pack sizes, MOQ, use cases |
| Product page (equipment) | 600+ | Need: specs, wattage, dimensions, use cases, warranty |
| Category page | 300+ | Need: intro copy explaining the category for B2B buyers |
| Homepage | 600+ | Need: USPs, B2B value props, trust signals |
| B2B/Wholesale landing page | 1,000+ | Need: onboarding process, payment terms, MOQ policy, account benefits |
| Blog post (Swedish) | 1,200+ | Swedish content competes less but still needs depth |

**Language note:** Primary language is Swedish. Evaluate Swedish content quality first. English content at /en/ is secondary. Norwegian /no/ and Danish /da/ are tertiary — thin content there is acceptable if Swedish is strong.
