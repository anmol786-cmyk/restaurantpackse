...
- **Wholesale B2B** *(this project)*: /wholesale, MOQ mentions, "grossist", "storköksvaror", B2B account registration, minimum order quantity, invoice payment terms, Wholesaler schema, HoReCa language, "restaurang leverantör" --> treat as Wholesale B2B, NOT generic e-commerce. Load `PROJECT-CONTEXT.md` for full context.
- **E-commerce**: /products, /collections, /cart, "add to cart", product schema
- **Publisher**: /blog, /articles, /topics, article schema, author pages, publication dates
- **Agency**: /case-studies, /portfolio, /industries, "our work", client logos

> **This project is restaurantpack.se — Anmol Wholesale.** It is a Swedish-market B2B wholesale distributor for restaurants. Primary language is Swedish. Always load `PROJECT-CONTEXT.md` before running any analysis on this project.
