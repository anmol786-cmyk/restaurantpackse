...
| **Wholesale Distributor** *(this project)* | /wholesale, "grossist", "storköksvaror", MOQ mentions, B2B account, invoice terms, "restaurang leverantör", bulk pricing tiers, HoReCa language |
...
**Swedish/Nordic B2B citation sources (restaurantpack.se priority list):**
| Directory | Priority | Notes |
|-----------|---------|-------|
| eniro.se | Tier 1 | Sweden's primary business directory (like Yelp) |
| hitta.se | Tier 1 | Major Swedish business finder |
| allabolag.se | Tier 1 | Swedish company registry info — auto-populated from Bolagsverket |
| ratsit.se | Tier 1 | Business ratings/info site — claim and verify |
| foretaget.se | Tier 2 | Swedish business listings |
| gulasidorna.se | Tier 2 | Swedish Yellow Pages |
| proff.se | Tier 2 | Nordic business info |
| linkedin.com/company | Tier 1 | B2B authority signal — critical for wholesale |
| facebook.com/business | Tier 1 | Already present (AnmolWholesale page) |
| google.com/business | Tier 1 | GBP — most critical |
